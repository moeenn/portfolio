---
title: "Password hashing in Golang"
desc: "User passwords should never be stored in clear-text on the server, they must always be hashed. This article walks through two secure ways of hashing passwords in a Golang back-end."
category: "Golang"
...
## Option 2: Using `argon2` (Recommended)
...
We can test if the above code works properly using the following test.
