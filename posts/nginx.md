---
title: "Nginx"
desc: "Nginx is an essential tool when setting up server and exposing our web-applications and services to the web. This is a guide on how to set it up."
category: "Misc"
tags: ["Setup", "Server"]
---
...
server{
    server_name mysite.com;
    location / {
        # enable streamed responses and web-sockets.
        proxy_buffering off;
