...
export const tools = [
    {
        title: "Focus in",
        tools: [Golang, Javascript, Typescript, NodeJS, React, TailwindCSS, Docker, PostgreSQL],
    },
    {
        title: "Good knowledge",
        tools: [
            Python, Express, NextJS, NestJS, VueJS, GraphQL, MongoDB, MySQL, Neo4j,
            RabbitMQ, Linux, Bash, Html, CSS, Git, Github, Jira,
        ],
    },
    {
        title: "Clouds",
...
export const projects: Project[] = [
    ...
    },
    {
        ...
        icon: SparklesIcon,
        imageCount: 6,
        tech: [NodeJS, Express, PostgreSQL, Typescript, TailwindCSS, GPT, Whisper, DID, Stripe, FFmpeg, Docker],
        features: [
