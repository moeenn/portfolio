...
export const projects: Project[] = [
	...
	},
	{
		id: "usaconvo",
		title: "USAConvo",
		desc: "For non-English speaking students, traditional language classes miss the mark on real-world fluency. USAConvo bridges that gap by uniting students, tutors, and institutes to teach conversational American English with genuine native nuances.",
		...
		features: [
			"Multi-Format Learning Modes: Supports diverse educational environments, including structured one-on-one tutoring, collaborative group sessions, and open-access public seminars and events.",
			"Instructor Previews & Sample Media: Enables tutors to upload free introductory lectures and course samples, allowing students to evaluate teaching styles and compatibility prior to booking.",
			"Advanced Tutor Search Engine: Features a comprehensive search interface with customizable filters to help students identify and connect with their ideal instructors.",
			"Institutional Program Directory: Hosts a dedicated registry of language schools and academic institutions offering specialized English programs for non-native speakers.",
			"Direct-Placement Job Board: Provides an integrated employment marketplace where qualified tutors can view openings and interface directly with educational institutions.",
			"Interactive Discussion Forums: Maintains a community-driven forum space dedicated to English language learning, peer support, and the discussion of native linguistic nuances.",
		],
	},
	{
		id: "fn-integrator",
